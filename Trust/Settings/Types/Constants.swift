...
public struct Constants {
    ...
    //修改
    public static let peepethDappsBrowserURL = "https://peepeth.com/welcome"
    ...
    public static let bancorAPI = URL(string: "https://api.bancor.network")!
    public static let bancorImageAPI = URL(string: "https://files.bancor.network")!
}
