...
public let SRLog = XCGLogger.default
public let SRLogFilePath = "logPath/debuglog.text"
...
class AppDelegate: UIResponder, UIApplicationDelegate, UISplitViewControllerDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        if let pa = path {
            let wholePath = pa + SRLogFilePath
            SRLog.setup(level: .debug, showThreadName: true, showLevel: true, showFileNames: true, showLineNumbers: true, writeToFile: wholePath, fileLevel: .debug)
        }
        return true
    }
